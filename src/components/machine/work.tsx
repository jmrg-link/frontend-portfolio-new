            ...
            <DepthFrame className="mt-4">
              <div className="relative overflow-hidden rounded-sm border border-groove bg-vfd-glass shadow-[inset_0_2px_10px_rgba(0,0,0,0.6)]">
                <CmsImage
                  ...
                  className="aspect-video w-full object-cover opacity-85 saturate-[0.85] transition-[opacity,filter,transform] duration-500 ease-out group-hover:scale-[1.03] group-hover:opacity-100 group-hover:saturate-100"
